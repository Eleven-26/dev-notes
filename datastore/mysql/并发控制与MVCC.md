...
> **选主流程见 [../distributed/Raft协议.md](../../distributed/Raft协议.md)**，
> **一致性等级与 CAP 取舍见 [../distributed/一致性与CAP.md](../../distributed/一致性与CAP.md)**。
...
> 跨服务/跨库的"锁"只能靠 Redis 分布式锁，实现与坑见 [../../middleware/redis/分布式锁.md](../../middleware/redis/分布式锁.md)。
