...
>
> 内容整理自大厂 Go 后端面试真题视频；本轮补充（镜像瘦身、构建缓存）参考《Docker 技术入门与实战》（第 3 版，杨保华 / 戴王剑 / 曹亚仑）。参考资料与原始素材见 [素材清单](../interview/素材清单.md)。

---

## Q1. 镜像瘦身怎么做才有效？（Go / Java 各自的办法）⭐
...
- [K8s部署与生命周期.md](K8s部署与生命周期.md) — 镜像变小对发布时长与冷启动的实际收益
