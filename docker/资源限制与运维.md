...
>
> 内容整理自大厂 Go 后端面试真题视频；本轮补充（资源限制与 137）参考《Docker 技术入门与实战》（第 3 版，杨保华 / 戴王剑 / 曹亚仑）。参考资料与原始素材见 [素材清单](../interview/素材清单.md)。
...
- [K8s部署与生命周期.md](K8s部署与生命周期.md) — imagePullPolicy、QoS 与探针
- [../java/JVM与垃圾回收.md](../java/JVM与垃圾回收.md) — JVM 感知 cgroup 的版本差异
