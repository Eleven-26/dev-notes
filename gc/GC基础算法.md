...
- [algorithms/复杂度分析.md](../algorithms/复杂度分析.md)：本文反复用到的"阶段复杂度 × 堆大小/存活集大小"分析方法。
