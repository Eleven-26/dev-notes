...
**考察意图**：上一题问「有哪些方案」，这题考**「机制怎么自动生效」**——重点在**租约（lease）**：为什么必须有 TTL、续租失败意味着什么、健康检查如何从「被动上报」变成「自动摘除」。
...
- [一致性与CAP.md](一致性与CAP.md) — 注册中心为什么多半选 AP
- [Raft协议.md](Raft协议.md) — etcd 的租约与 Watch
- [../中间件/Nacos.md](../中间件/Nacos.md) — 注册中心的成品实现
- [../网络/DNS解析.md](../网络/DNS解析.md) — 另一层「负载均衡」：DNS 轮询与 GSLB
